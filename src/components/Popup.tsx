...
export const Popup = ({
  ...
  <div className="tw-summarizer-grid tw-summarizer-grid-cols-1 tw-summarizer-divide-y tw-summarizer-divide-gray-200 tw-summarizer-w-64">
    ...
    <div className="tw-summarizer-px-4 tw-summarizer-py-2">
      ...
      >
        <div id="summarizer-toggle" className="tw-summarizer-relative">
          <input
            type="checkbox"
            id="enableToggle"
          ...
          />
          <div
            id="summarizer-toggle-dot"
            className={`tw-summarizer-absolute tw-summarizer-left-1 tw-summarizer-top-1 tw-summarizer-bg-white tw-summarizer-w-4 tw-summarizer-h-4 tw-summarizer-rounded-full tw-summarizer-transition ${
