        ...
        <p>
          ...
          <ul className="tw-summarizer-list-disc tw-summarizer-pl-4 tw-summarizer-space-y-1 tw-summarizer-text-gray-500">
            <li>
              ...
              on-device (no API key needed), but requires a one-time model download and may be
              slower.
            </li>
            <li>
              <strong className="tw-summarizer-text-gray-800">Cloud providers</strong> (OpenAI,
              Claude, Gemini, DeepSeek) are faster and return a richer structured triage, but
              require an API key.
            </li>
          </ul>
        </p>
